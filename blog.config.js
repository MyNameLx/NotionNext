...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://leedu.ac.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, ChatGPT, OpenAI, Claude, bewildcard, ChatGPT升级', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '1038581458@qq.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://leedu.ac.cn', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'LeeBlog, 一个折腾的地方', // 站点描述，被notion中的页面描述覆盖
